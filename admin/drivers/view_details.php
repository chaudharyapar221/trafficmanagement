...
<div class="container-fluid">
    ...
    <div class="border border-dark px-2 py-2" id="print_out">
                ...
                <td width="80%" class='boder-0 align-bottom'>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Designation officer:</label>
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $license_type ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Last / First Name:</label>
        ...
        <h4 class="text-center"><b>Find Collection Records</b></h4>
        <table class='table table-stripped px-4'>
            <thead>
                <tr>
                    <th>DateTime</th>
                    <th>Rule Break Report </th>
                    <th>Fine</th>
                    <th>Status</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left"><?php echo number_format($row['fine'],2) ?></td>

...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Officer</h3>
	</div>
	<div class="card-body">
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						<label for="license_id_no" class="control-label">Officer Id.</label>
					...
					<div class="form-group">
						<label for="present_address" class="control-label">Current Address</label>
				...
				<div class="col-6">
					...
					<div class="form-group">
						<label for="license_type" class="control-label">Designation officer</label>
						<select name="license_type" id="license_type" class="custom-select select2">
							<option <?php echo (isset($license_type) && $license_type == 'Student') ? 'selected' : '' ?>>Sub-Inespector</option>
							<option <?php echo (isset($license_type) && $license_type == 'Non-Professional') ? 'selected' : '' ?>>Hawaldar</option>
							<option <?php echo (isset($license_type) && $license_type == 'Professional') ? 'selected' : '' ?>>Inespector</option>
							<option <?php echo (isset($license_type) && $license_type == 'Professional') ? 'selected' : '' ?>>Ashai</option>
							<option <?php echo (isset($license_type) && $license_type == 'Professional') ? 'selected' : '' ?>>Traffic officer</option>

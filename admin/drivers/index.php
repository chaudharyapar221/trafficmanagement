...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">LIST Of OFFICER USER</h3>
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("<i class='fa fa-id-card'></i> Officer's Users Information / Collection Fine Record","drivers/view_details.php?id="+$(this).attr('data-id'),'large')
		})
		$('.table').dataTable({
			columnDefs: [

...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Insert New Rule" ?> Of The Government</h3>
	</div>
	<div class="card-body">
		<form action="" id="offense-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group col-6">
				<label for="code" class="control-label">Traffic Rule Code</label>
                <input name="code" id="code" maxlength="20" type="text" class="form-control form" value="<?php echo isset($code) ? $code : ''; ?>"/>
			</div>
			<div class="form-group col-6">
				<label for="name" class="control-label">Traffic Main Rule</label>

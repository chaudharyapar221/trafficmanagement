    ...
    <style>
        ...
        <table class="table boder-0">
                        ...
                        <div class="col-12">
                            <div class="row justify-content-between  w-max-100">
                                <div class="col-6 d-flex w-max-100">
                                    <label class="float-left w-auto whitespace-nowrap">Register No: </label>
            ...
            <tr>
                <td colspan='2'>
                    <div class="d-flex w-max-100">
                        <label class="float-left w-auto whitespace-nowrap">License_No:</label>
                        <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $officer_id ?></b></p>
                    </div>
                    <div class="d-flex w-max-100">
                        <label class="float-left w-auto whitespace-nowrap">Driver Name:</label>
                        <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $officer_name ?></b></p>
                    </div>
                    <hr>
                    <div class="d-flex w-max-100">
                        <label class="float-left w-auto whitespace-nowrap">Payment Status:</label>
        ...
        <h4 class="text-center"><b>Fine Rule Break List with Billling</b></h4>

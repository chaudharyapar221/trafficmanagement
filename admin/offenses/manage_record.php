	...
	<div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="form-group">
                    <lable class="control-label" for="ticket_no">Register No.</lable>
                    <input type="text" class="form-control" name="ticket_no" id="ticket_no" value="<?php echo isset($ticket_no) ? $ticket_no : '' ?>" required>
                </div>
                <div class="form-group">
                    <lable class="control-label" for="driver_id">Officer's Id / Name</lable>
            ...
            <div class="col-6">
                <div class="form-group">
                    <lable class="control-label" for="officer_id">Licience No.</lable>
                    <input type="text" class="form-control" name="officer_id" id="officer_id" value="<?php echo isset($officer_id) ? $officer_id : '' ?>" required>
                </div>
                <div class="form-group">
                    <lable class="control-label" for="officer_name">Driver Name.</lable>
        ...
        <div class="row">
            <div class="col-6">
                <h5 class='border-bottom border-light'><b>TRAFFIC RULE OF GOVERNMENT FINE</b></h5>
                <div class="row">
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        end_loader();
                        uni_modal("<i class='fa fa-ticket'></i> Nepal Police Fine Billing","offenses/view_details.php?id="+resp.id,'mid-large')
                        setTimeout(() => {
                            end_loader();
                        }, 500);

...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">LIST OF DRIVER BREAKING RULE</h3>
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("<i class='fa fa-ticket'></i> Nepal Police Fine Billing","offenses/view_details.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.table').dataTable({
